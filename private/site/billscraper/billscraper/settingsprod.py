"""
Django settings for production version of policy database.
...
ALLOWED_HOSTS = ['aipolicydatabase.com', '146.190.121.58']
...
MIDDLEWARE = [
    ...
    'billscraper.middleware.AllowIframeMiddleware',
]
